 ...
 */
import { ExtensionType, BufferResource, Texture, BaseTexture, extensions } from '@pixi/core';
...
var BASIS_FORMAT_TO_INTERNAL_FORMAT = (_a = {},
    ...
    _a[BASIS_FORMATS.cTFASTC_4x4] = INTERNAL_FORMATS.COMPRESSED_RGBA_ASTC_4x4_KHR,
    _a);
/**
...
var TranscoderWorker = /** @class */ (function () {
    ...
    TranscoderWorker.onTranscoderInitialized = new Promise(function (resolve) {
 ...
 */
var BasisParser = /** @class */ (function () {
    function BasisParser() {
    }
    /**
     ...
     * @private
     */
    BasisParser.transcode = function (arrayBuffer) {
        return __awaiter(this, void 0, Promise, function () {
            var resources;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(typeof Worker !== 'undefined' && BasisParser.TranscoderWorker.wasmSource)) { return [3 /*break*/, 2]; }
                        return [4 /*yield*/, BasisParser.transcodeAsync(arrayBuffer)];
                    case 1:
                        resources = _a.sent();
                        return [3 /*break*/, 3];
                    case 2:
     ...
     * @async
     */
    BasisParser.transcodeAsync = function (arrayBuffer) {
        return __awaiter(this, void 0, Promise, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        workerPool = BasisParser.workerPool;
                    ...
                    case 1:
                        // Wait until worker is ready
                        _a.sent();
                        return [4 /*yield*/, worker.transcodeAsync(new Uint8Array(arrayBuffer), BasisParser.defaultRGBAFormat.basisFormat, BasisParser.defaultRGBFormat.basisFormat)];
                    case 2:
                        response = _a.sent();
     ...
     * @private
     */
    BasisParser.transcodeSync = function (arrayBuffer) {
        if (!BasisParser.defaultRGBAFormat && !BasisParser.defaultRGBFormat) {
            BasisParser.autoDetectFormats();
        }
        var BASIS = BasisParser.basisBinding;
        ...
        var fallbackMode = BasisParser.fallbackMode;
        if (!basisFile.startTranscoding()) {
     ...
     * @ignore
     */
    BasisParser.autoDetectFormats = function (extensions) {
     ...
     * @private
     */
    BasisParser.bindTranscoder = function (basisLibrary) {
     ...
     * @param wasmURL - URL to the wasm basis transcoder
     */
    BasisParser.loadTranscoder = function (jsURL, wasmURL) {
     ...
     * @param wasmSource - source for the wasm basis transcoder
     */
    BasisParser.setTranscoder = function (jsSource, wasmSource) {
        BasisParser.TranscoderWorker.setTranscoder(jsSource, wasmSource);
    };
    Object.defineProperty(BasisParser, "TRANSCODER_WORKER_POOL_LIMIT", {
        get: function () {
    ...
    /** @ignore */
    BasisParser.extension = ExtensionType.Loader;
    BasisParser.fallbackMode = false;
    BasisParser.workerPool = [];
    BasisParser.TranscoderWorker = TranscoderWorker;
    return BasisParser;
}());
...
var BasisLoader = /** @class */ (function () {
        ...
        if (resource.extension === 'basis' && resource.data) {
            (function () { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(!BasisParser.basisBinding && (!BasisParser.TranscoderWorker.wasmSource))) { return [3 /*break*/, 2]; }
                            return [4 /*yield*/, TranscoderWorker.onTranscoderInitialized];
                        case 1:
                            _a.sent();
                            _a.label = 2;
                        case 2: return [4 /*yield*/, BasisParser.transcode(resource.data)];
                        case 3:
                            resources = _a.sent();
    ...
    /** @ignore */
    BasisLoader.extension = ExtensionType.Loader;
    return BasisLoader;
}());

extensions.add(BasisLoader);

export { BASIS_FORMATS, BASIS_FORMATS_ALPHA, BASIS_FORMAT_TO_INTERNAL_FORMAT, BASIS_FORMAT_TO_TYPE, BasisLoader, BasisParser, INTERNAL_FORMAT_TO_BASIS_FORMAT, TranscoderWorker };
