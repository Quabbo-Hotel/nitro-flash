    ...
    return (
        <Grid className="mt-n1">
            <Column size={ 7 } overflow="hidden" style={ { height: `calc(100% - ${ !isTrading ? '34px' : '5px' })` } }>
                <AutoGrid style={{ paddingRight: '6px' }} gap={ 1 } columnCount={ 5 } className={ isTrading ? 'trading-inventory' : '' }>
                            ...
                            { (!isTrading) &&
                                <>
                                    ...
                                    { (selectedItem && selectedItem.isSellable) &&
                                        <Button className="p-0 px-2" style={{marginBottom:"10px"}} onClick={ event => attemptPlaceMarketplaceOffer(selectedItem) }>
